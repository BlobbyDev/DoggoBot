...
```
Search `GOOGLE_KEY` & `ENGINE_ID` can be obtained from [here](https://cse.google.com/cse/), `YT_KEY` from [here](https://console.cloud.google.com/apis/library/youtube.googleapis.com?q=you&id=125bab65-cfb6-4f25-9826-4dcc309bc508&project=ninth-psyche-296311) and IMDB from [here](https://developer.imdb.com/)
