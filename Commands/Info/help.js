...
module.exports = {
    ...
    run: async (client, message, args) => {
        const Fun = "```8ball, Ascii, PP, Rps, Coinflip, Roll, Tictactoe, Simprate, Gayrate```";
        ...
        const Utility = "```Avatar, Covid, Embed, Say, Urban, Weather, Translate, Youtube```";
        const Image = "```Meme, Dog, Fox, Bird, Cat, Panda, RedPanda, Koala```";
        const Fact = "```Catfact, Dogfact, Pandafact, Birdfact, Foxfact, Koalafact```";
        const Others = "```Invite, Support```";
