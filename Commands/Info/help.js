...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const Image = "```Meme, Bonk, Trumptweet, Invert, Gay, Trigger, Jail, Affect, Trash, Blur, Greyscale, Sepia, Blink, Delete, Kiss, Present, Slap, Spank, Wanted```";
        const Animals = "```Dog, Fox, Bird, Cat, Panda, RedPanda, Koala, Shibe, Catfact, Dogfact, Pandafact, Birdfact, Foxfact, Koalafact```";
        ...
        .addField(`${emoji.Camera} Image`, Image, true)
        .addField(`${emoji.DoggoLul} Animals`, Animals, true)
